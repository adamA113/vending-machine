...
public class Calculator implements CalculatorInterface {
    ...
    public CoinBundle calculateChange(int amountMoneyToReturn) {
        ...
        change.number5000CentsCoins = remainingAmount / Coin.FIFTY_BUCKS.getValue();
        remainingAmount = remainingAmount % Coin.FIFTY_BUCKS.getValue();

        change.number2000CentsCoins = remainingAmount / Coin.TWENTY_BUCKS.getValue();
        remainingAmount = remainingAmount % Coin.TWENTY_BUCKS.getValue();
