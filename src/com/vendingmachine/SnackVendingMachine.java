...
public class SnackVendingMachineInterface implements VendingMachineInterface {

    private VendingMachineController controller = new SnackVendingMachineController();
    ...
    public void selectProduct(int product) {
        ...
        //int tag = Product.getSelectionTag
    ...
    public void displayEnterCoinsMessage() {
        ...
        System.out.println(" num of 10 cents coins,num of 20 cents coins,num of 50 cents coins,num of 100 cents coins, num of 2000 cents coins, num of 5000 cents coins  ");
        System.out.println("                                              ");
    ...
    public void displayChangeMessage() {
        ...
        System.out.println("    5000 cents coins: "+ change.number5000CentsCoins);
        System.out.println("    2000 cents coins: "+ change.number2000CentsCoins);
